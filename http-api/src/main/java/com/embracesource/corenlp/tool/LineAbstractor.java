 ...
 * @date	2017年11月28日 下午2:46:54
 * @copyright	http://www.embracesource.com
 */
public class LineAbstractor {
	
	static final StanfordCoreNLP CORE_NLP = new StanfordCoreNLP("StanfordCoreNLP-chinese.properties");
	static final Pattern LINE_PTN = Pattern.compile("([^x00-xff]+线)");
	static final String SPLIT_PTN = "[[\\p{P}||\\p{S}]&&[^、\\-\\_——\\+``“”]]+";
	static final String CHARSET_ENCODE = "UTF-8";
	static final File OUTPUT_FILE_PATH = new File("C:/Users/admin/Desktop/line_1-200.out");
	static final File INPUT_FILE_PATH = new File("C:/Users/admin/Desktop/accident_txt/test");
		...
		try {
			...
			for (CoreMap sentence : sentences) {
				...
				for (String str : strArr) {
					Matcher matcher = LINE_PTN.matcher(str);
					while(matcher.find()) {
